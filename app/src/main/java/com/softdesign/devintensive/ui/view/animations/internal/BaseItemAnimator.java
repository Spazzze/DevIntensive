package com.softdesign.devintensive.ui.view.animations.internal;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private int lastRemoveAnimatedItem = -1;
    ...
    public boolean animateRemove(final ViewHolder holder) {
        lastRemoveAnimatedItem = holder.getOldPosition();
        endAnimation(holder);
    ...
    protected long getRemoveDelay(final RecyclerView.ViewHolder holder) {
        return Math.abs((holder.getOldPosition() - lastRemoveAnimatedItem) * getRemoveDuration() / 4);
    }

    @Override
    public boolean animateAdd(final ViewHolder holder) {
        lastAddAnimatedItem = holder.getAdapterPosition();
        endAnimation(holder);
    ...
    protected long getAddDelay(final RecyclerView.ViewHolder holder) {
        return Math.abs((holder.getAdapterPosition() - lastAddAnimatedItem) * getAddDuration() / 4);
    }
