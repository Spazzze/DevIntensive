...
public class UserListViewModel extends BaseViewModel implements Parcelable {
    ...
    public UserListViewModel(UserEntity user) {
    ...
    public void updateValues(@Nullable UserListViewModel model) {
    ...
    public static final Parcelable.Creator<UserListViewModel> CREATOR = new Parcelable.Creator<UserListViewModel>() {
        @Override
